      ...
      <div class="row">
        <div class="col">
          ...
          <nav class="navbar navbar-expand-lg">
            <a href="index.html"><img class="logo-nav" src="images/logo.png" alt="logo"></a> 
          ...
          <div class="row">
            <div class="col-lg-4 col-md-4 mt-5 mt-md-0 footer-menu">
              <ul class="list-unstyled w-100">
                ...
                <li>
                  <a href="index.html" target="_blank">Andilab</a>
                </li>
                <!--<li>
                  <a href="servizi.html" target="_blank">Servizi</a>
                </li>-->
              </ul>
            </div>
            <div class="col-lg-4 col-md-4 mt-5 mt-md-0 footer-menu">
              <ul class="list-unstyled w-100">
                ...
                <li>
                  <a href="contatti.php" target="_blank">Contattaci</a>
                </li>
                <!--<li>
                  <a href="contatti.php" target="_blank">Contattaci</a>
                </li>-->
            ...
            <div class="col-lg-4 col-md-4 mt-5 mt-md-0 footer-menu">
              <ul class="list-unstyled">
                ...
                <li>
                  <a href="politica-aziendale.html" target="_blank">Politica aziendale</a>
                </li>
                <!--<li>
